...
function magic() {
  if (simsubscreennum == 1) {
                      ...
                      document.getElementById("sub1").onclick = function () {
                        ...
                        document.getElementById("num-3").style.visibility =
                          ...
                          setTimeout(function () {
                            document.getElementById("7-1-6").style.visibility =
                        "hidden";
                        document.getElementById("7-1-61").style.visibility =
                        "visible";
                            document.getElementById("7-1-61").style.animation =
                            "movearrow21 30s forwards";
                      ...
                      document.getElementById("sub1").onclick = function () {
                        ...
                        document.getElementById("num-3").style.visibility =
                          ...
                          setTimeout(function () {
                            document.getElementById("7-1-6").style.visibility =
                        "hidden";
                        document.getElementById("7-1-62").style.visibility =
                        "visible";
                            document.getElementById("7-1-62").style.animation =
                            "movearrow31 30s forwards";
                            setTimeout(function () {
                              document.getElementById("7-1-62").style.visibility =
                              "hidden";
    ...
    document.getElementById("8-1-6").style.visibility = "hidden";
    ...
    switch(fh.value){
      case "100":
        document.getElementById("t100").style.visibility = "visible";
        break;
        case "120":
          document.getElementById("t120").style.visibility = "visible";
        break;
        case "150":
          document.getElementById("t150").style.visibility = "visible";
        break;
    }
...
function handleFlightSelection(e) {
  ...
  document.getElementById("demo3").innerHTML = " No of batteries: " + battery;
}
...
//       case "four":
//         document.getElementById("8-1-2").style.visibility = "hidden";
//         document.getElementById("8-1-6").style.visibility = "visible";
//         document.getElementById("8-1-3").style.visibility = "hidden";
//         document.getElementById("8-1-4").style.visibility = "hidden";
//         document.getElementById("8-1-5").style.visibility = "hidden";
//         break;
